...
class EditorTrashNotAvailableDeletePermissionTest extends GraphqlTestCase {
  ...
  public function testPermission() {
    assertTypePathNotExists(['Mutation', 'trash'], 'mutation.trash field is not available if user has no page-delete permission.');
  }
}